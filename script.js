...
// 定義各類遊戲音效
function soundDeal() { playSyntheticSound(600, 'sine', 0.1, 0.8); }
function soundChip() { playSyntheticSound(150, 'triangle', 0.2, 0.8); }
function soundWin() {
    playSyntheticSound(523, 'sine', 0.1, 0.8); // C5
